  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tempat</h2> 
          <div class="pull-right">Terakhir diubah: {{$data->updated_at->format('d M Y')}}</div>
        ...
        <div class="x_content">
          ...
          <form id="demo-form" enctype="multipart/form-data" action="{{url('/tempat/update', $data->id)}}" method="POST" data-parsley-validate>
            {!! csrf_field() !!}
            <br/><label for="tempat">Nama Tempat * :</label>
            <input type="text" id="fullname" class="form-control" name="tempat" value="{{ $data->nama_tempat }}" placehoder="nama tempat"  required />
            ...
            <select id="heard" class="form-control" name="kategori" required>
              ...
              @foreach($kategori as $kategor)
                @if( $kategor->id == $data->kategori_id )
                  <option value="{{$kategor->id}}" selected>{{ $kategor -> nama_kategori }}</option>
                @else
            ...
            <input type="text" id="fullname" class="form-control" name="alamat" value="{{ $data->alamat }}" placehoder="alamat" required />
            ...
            <img id="img-upload" src="/images/{{$data->image}}" />
